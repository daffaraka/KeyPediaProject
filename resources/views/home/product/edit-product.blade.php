...
<form action="{{route('updateProduct',$product->product_id)}}" method="POST" enctype="multipart/form-data">
    <div class="row" style="padding: 20px;box-shadow: grey 0 0 3px; border-radius:5px;">
        ...
        <div class="col-md-5" >
            ...
            class="rounded"
            src="{{asset('image_product/'.$product->image_product)}}"
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_product" aria-describedby="emailHelp" value="{{$product->nama_product}}">
                <small class="form-text text-muted">Tentukan nama keyboard</small>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1" class="font-weight-bolder">Harga</label>
                <input type="text" class="form-control" name="harga_product" aria-describedby="emailHelp" value="{{$product->harga_product}}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="deskripsi_product" aria-describedby="emailHelp" value="{{$product->deskripsi_product}}">
